const DEFAULT_CONFIG = {
  ...
  "dictionary": {
    ...
    /* Sidebar field labels. The JSON key in "fields" is the placeholder
       identity — [ticketID] resolves, fieldCards matches and googleSheetFields
       exports against it — so only the printed label is translated.
       ssid / dns / vpn / url carry no entry on purpose: the acronym is the
       same in all five languages. */
    "ticketID": { "es": "ID del Ticket", "en": "Ticket ID", "pt": "ID do Chamado", "ja": "チケットID", "ru": "Номер заявки" },
    "requesterName": { "es": "Nombre del Solicitante", "en": "Requester Name", "pt": "Nome do Solicitante", "ja": "依頼者名", "ru": "Имя заявителя" },
    "requesterEmail": { "es": "Correo del Solicitante", "en": "Requester Email", "pt": "E-mail do Solicitante", "ja": "依頼者のメール", "ru": "Эл. почта заявителя" },
    "requesterUser": { "es": "Usuario del Solicitante", "en": "Requester User", "pt": "Usuário do Solicitante", "ja": "依頼者のユーザー名", "ru": "Учётная запись заявителя" },
    "department": { "es": "Departamento", "en": "Department", "pt": "Departamento", "ja": "部署", "ru": "Отдел" },
    "location": { "es": "Ubicación", "en": "Location", "pt": "Localização", "ja": "拠点", "ru": "Расположение" },
    "requestType": { "es": "Tipo de Solicitud", "en": "Request Type", "pt": "Tipo de Solicitação", "ja": "依頼の種別", "ru": "Тип обращения" },
    "category": { "es": "Categoría", "en": "Category", "pt": "Categoria", "ja": "カテゴリ", "ru": "Категория" },
    "subcategory": { "es": "Subcategoría", "en": "Subcategory", "pt": "Subcategoria", "ja": "サブカテゴリ", "ru": "Подкатегория" },
    "priority": { "es": "Prioridad", "en": "Priority", "pt": "Prioridade", "ja": "優先度", "ru": "Приоритет" },
    "impact": { "es": "Impacto", "en": "Impact", "pt": "Impacto", "ja": "影響範囲", "ru": "Влияние" },
    "urgency": { "es": "Urgencia", "en": "Urgency", "pt": "Urgência", "ja": "緊急度", "ru": "Срочность" },
    "assetTag": { "es": "Etiqueta de Activo", "en": "Asset Tag", "pt": "Etiqueta do Ativo", "ja": "資産タグ", "ru": "Инвентарный номер" },
    "deviceType": { "es": "Tipo de Dispositivo", "en": "Device Type", "pt": "Tipo de Dispositivo", "ja": "機器の種類", "ru": "Тип устройства" },
    "manufacturer": { "es": "Fabricante", "en": "Manufacturer", "pt": "Fabricante", "ja": "メーカー", "ru": "Производитель" },
    "model": { "es": "Modelo", "en": "Model", "pt": "Modelo", "ja": "型番", "ru": "Модель" },
    "serialNumber": { "es": "Número de Serie", "en": "Serial Number", "pt": "Número de Série", "ja": "シリアル番号", "ru": "Серийный номер" },
    "hostname": { "es": "Nombre del Equipo", "en": "Hostname", "pt": "Nome do Host", "ja": "ホスト名", "ru": "Имя узла" },
    "os": { "es": "SO", "en": "OS", "pt": "SO", "ja": "OS", "ru": "ОС" },
    "osVersion": { "es": "Versión del SO", "en": "OS Version", "pt": "Versão do SO", "ja": "OSのバージョン", "ru": "Версия ОС" },
    "architecture": { "es": "Arquitectura", "en": "Architecture", "pt": "Arquitetura", "ja": "アーキテクチャ", "ru": "Архитектура" },
    "kernelVersion": { "es": "Versión del Kernel", "en": "Kernel Version", "pt": "Versão do Kernel", "ja": "カーネルのバージョン", "ru": "Версия ядра" },
    "browser": { "es": "Navegador", "en": "Browser", "pt": "Navegador", "ja": "ブラウザ", "ru": "Браузер" },
    "browserVersion": { "es": "Versión del Navegador", "en": "Browser Version", "pt": "Versão do Navegador", "ja": "ブラウザのバージョン", "ru": "Версия браузера" },
    "appName": { "es": "Aplicación", "en": "Application", "pt": "Aplicativo", "ja": "アプリ名", "ru": "Приложение" },
    "appVersion": { "es": "Versión de la Aplicación", "en": "App Version", "pt": "Versão do Aplicativo", "ja": "アプリのバージョン", "ru": "Версия приложения" },
    "installMethod": { "es": "Método de Instalación", "en": "Install Method", "pt": "Método de Instalação", "ja": "インストール方法", "ru": "Способ установки" },
    "virtualized": { "es": "Virtualizado", "en": "Virtualized", "pt": "Virtualizado", "ja": "仮想環境", "ru": "Виртуализировано" },
    "networkType": { "es": "Tipo de Red", "en": "Network Type", "pt": "Tipo de Rede", "ja": "ネットワークの種別", "ru": "Тип сети" },
    "localIP": { "es": "IP Local", "en": "Local IP", "pt": "IP Local", "ja": "ローカルIP", "ru": "Локальный IP" },
    "gateway": { "es": "Puerta de Enlace", "en": "Gateway", "pt": "Gateway", "ja": "ゲートウェイ", "ru": "Шлюз" },
    "proxy": { "es": "Proxy", "en": "Proxy", "pt": "Proxy", "ja": "プロキシ", "ru": "Прокси" },
    "port": { "es": "Puerto", "en": "Port", "pt": "Porta", "ja": "ポート", "ru": "Порт" },
    "summary": { "es": "Resumen", "en": "Summary", "pt": "Resumo", "ja": "概要", "ru": "Краткое описание" },
    "errorMessage": { "es": "Mensaje de Error", "en": "Error Message", "pt": "Mensagem de Erro", "ja": "エラーメッセージ", "ru": "Сообщение об ошибке" },
    "whenStarted": { "es": "Cuándo Comenzó", "en": "When Started", "pt": "Quando Começou", "ja": "発生した日時", "ru": "Когда началось" },
    "frequency": { "es": "Frecuencia", "en": "Frequency", "pt": "Frequência", "ja": "発生頻度", "ru": "Частота" },
    "reproSteps": { "es": "Pasos para Reproducir", "en": "Repro Steps", "pt": "Passos para Reproduzir", "ja": "再現手順", "ru": "Шаги воспроизведения" },
    "expected": { "es": "Resultado Esperado", "en": "Expected", "pt": "Resultado Esperado", "ja": "期待される動作", "ru": "Ожидаемый результат" },
    "actual": { "es": "Resultado Real", "en": "Actual", "pt": "Resultado Real", "ja": "実際の動作", "ru": "Фактический результат" },
    "recentChange": { "es": "Cambio Reciente", "en": "Recent Change", "pt": "Mudança Recente", "ja": "直近の変更", "ru": "Недавнее изменение" },
    "lastKnownWorking": { "es": "Último Funcionamiento Correcto", "en": "Last Known Working", "pt": "Último Funcionamento Correto", "ja": "最後に正常だった時点", "ru": "Когда работало в последний раз" },
    "workaround": { "es": "Solución Temporal", "en": "Workaround", "pt": "Solução Alternativa", "ja": "回避策", "ru": "Обходное решение" },
    "projectName": { "es": "Proyecto", "en": "Project Name", "pt": "Projeto", "ja": "プロジェクト名", "ru": "Проект" },
    "dueDate": { "es": "Fecha Límite", "en": "Due Date", "pt": "Prazo", "ja": "期日", "ru": "Срок" },
    "logs": { "es": "Logs", "en": "Logs", "pt": "Logs", "ja": "ログ", "ru": "Журналы" },
    "screenshots": { "es": "Capturas de Pantalla", "en": "Screenshots", "pt": "Capturas de Tela", "ja": "スクリーンショット", "ru": "Скриншоты" },
    "remoteAccess": { "es": "Acceso Remoto", "en": "Remote Access", "pt": "Acesso Remoto", "ja": "リモート接続", "ru": "Удалённый доступ" },
    "maintenanceWindow": { "es": "Ventana de Mantenimiento", "en": "Maintenance Window", "pt": "Janela de Manutenção", "ja": "保守作業の時間帯", "ru": "Окно обслуживания" },

    /* Dropdown values from "fieldOptions". Only the printed option translates —
       the stored value stays the authored key, so saved tickets and the
       fieldCards mapping keep matching whatever language the agent used.
       "Software" and "Hardware" already have entries above (same word, same
       meaning as the section headers). P1-P4 and the OS / Wi-Fi names carry no
       entry: they read the same in all five languages. */
    "Network": { "es": "Red", "en": "Network", "pt": "Rede", "ja": "ネットワーク", "ru": "Сеть" },
    "Access": { "es": "Acceso", "en": "Access", "pt": "Acesso", "ja": "アクセス権", "ru": "Доступ" },
    "Security": { "es": "Seguridad", "en": "Security", "pt": "Segurança", "ja": "セキュリティ", "ru": "Безопасность" },
    "Incident": { "es": "Incidente", "en": "Incident", "pt": "Incidente", "ja": "インシデント", "ru": "Инцидент" },
    "Request": { "es": "Solicitud", "en": "Request", "pt": "Solicitação", "ja": "依頼", "ru": "Запрос" },
    "Change": { "es": "Cambio", "en": "Change", "pt": "Mudança", "ja": "変更", "ru": "Изменение" },
    "Problem": { "es": "Problema", "en": "Problem", "pt": "Problema", "ja": "問題", "ru": "Проблема" },
    "Organization": { "es": "Toda la Organización", "en": "Organization", "pt": "Toda a Organização", "ja": "組織全体", "ru": "Вся организация" },
    "Department": { "es": "Departamento", "en": "Department", "pt": "Departamento", "ja": "部署全体", "ru": "Отдел" },
    "Multiple users": { "es": "Varios usuarios", "en": "Multiple users", "pt": "Vários usuários", "ja": "複数のユーザー", "ru": "Несколько пользователей" },
    "Single user": { "es": "Un solo usuario", "en": "Single user", "pt": "Um único usuário", "ja": "単一ユーザー", "ru": "Один пользователь" },
    "Critical": { "es": "Crítica", "en": "Critical", "pt": "Crítica", "ja": "重大", "ru": "Критическая" },
    "High": { "es": "Alta", "en": "High", "pt": "Alta", "ja": "高", "ru": "Высокая" },
    "Medium": { "es": "Media", "en": "Medium", "pt": "Média", "ja": "中", "ru": "Средняя" },
    "Low": { "es": "Baja", "en": "Low", "pt": "Baixa", "ja": "低", "ru": "Низкая" },
    "Laptop": { "es": "Portátil", "en": "Laptop", "pt": "Notebook", "ja": "ノートPC", "ru": "Ноутбук" },
    "Desktop": { "es": "Equipo de Escritorio", "en": "Desktop", "pt": "Desktop", "ja": "デスクトップPC", "ru": "Настольный ПК" },
    "Tablet": { "es": "Tableta", "en": "Tablet", "pt": "Tablet", "ja": "タブレット", "ru": "Планшет" },
    "Phone": { "es": "Teléfono", "en": "Phone", "pt": "Telefone", "ja": "スマートフォン", "ru": "Телефон" },
    "Server": { "es": "Servidor", "en": "Server", "pt": "Servidor", "ja": "サーバー", "ru": "Сервер" },
    "Virtual": { "es": "Máquina Virtual", "en": "Virtual", "pt": "Máquina Virtual", "ja": "仮想マシン", "ru": "Виртуальная машина" },
    "Ethernet": { "es": "Ethernet", "en": "Ethernet", "pt": "Ethernet", "ja": "有線LAN", "ru": "Ethernet" },
    "Cellular": { "es": "Datos Móviles", "en": "Cellular", "pt": "Dados Móveis", "ja": "モバイル回線", "ru": "Мобильная сеть" },
    "Yes": { "es": "Sí", "en": "Yes", "pt": "Sim", "ja": "はい", "ru": "Да" },
    "No": { "es": "No", "en": "No", "pt": "Não", "ja": "いいえ", "ru": "Нет" },
    "N/A": { "es": "N/A", "en": "N/A", "pt": "N/A", "ja": "該当なし", "ru": "Н/Д" },
    "Always": { "es": "Siempre", "en": "Always", "pt": "Sempre", "ja": "常に発生", "ru": "Всегда" },
    "Often": { "es": "Frecuente", "en": "Often", "pt": "Frequente", "ja": "頻繁に発生", "ru": "Часто" },
    "Intermittent": { "es": "Intermitente", "en": "Intermittent", "pt": "Intermitente", "ja": "断続的", "ru": "Периодически" },
    "Once": { "es": "Una vez", "en": "Once", "pt": "Uma vez", "ja": "一度だけ", "ru": "Один раз" },
